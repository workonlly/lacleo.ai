...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      onOpenAutoFocus={(e) => {
        // Let Radix manage focus without custom aria toggles
      }}
      onCloseAutoFocus={(e) => {
        // Prevent focus glitches on close when animations run
        // Radix will restore focus to the trigger by default
      }}
      {...props}
    >
      {children}
