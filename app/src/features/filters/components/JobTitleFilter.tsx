...
export const JobTitleFilter = () => {
  ...
  const handleManualAdd = (title: string, mode: "include" | "exclude") => {
  ...
  return (
    <div className="flex flex-col gap-4 p-1">
      ...
      <div className="space-y-3">
        {includes.length > 0 && (
          <div className="space-y-1.5">
            <span className="text-[10px] font-bold uppercase text-blue-600 dark:text-blue-400">Included Titles</span>
        ...
        {excludes.length > 0 && (
          <div className="space-y-1.5">
            <span className="text-[10px] font-bold uppercase text-red-600 dark:text-red-400">Excluded Titles</span>
            <div className="flex flex-wrap gap-1.5">
              {excludes.map((item) => (
                <span
                  key={item.id}
      ...
      <div className="rounded border border-dashed bg-gray-50 p-2 text-[10px] text-gray-500 dark:border-gray-800 dark:bg-gray-900">
        Tip: Press Enter or use commas to add multiple titles. Exact phrases match with high priority.
      </div>
    </div>
  )
}
